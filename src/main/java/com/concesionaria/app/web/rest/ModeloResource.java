...
/**
 * REST controller for managing {@link com.concesionaria.app.domain.Modelo}.
 */
@RestController
...
public class ModeloResource {
    ...
    public ResponseEntity<ModeloDTO> createModelo(@Valid @RequestBody ModeloDTO modeloDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/modelos/" + modeloDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, modeloDTO.getId().toString()))
            .body(modeloDTO);
    }
    ...
    public ResponseEntity<ModeloDTO> updateModelo(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, modeloDTO.getId().toString()))
            .body(modeloDTO);
    }
    ...
    public ResponseEntity<ModeloDTO> partialUpdateModelo(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, modeloDTO.getId().toString())
        );
    }
