        ...
        /**
         * REST controller for managing {@link com.concesionaria.app.domain.Cliente}.
         */
        @RestController
        ...
        public class ClienteResource {
            ...
            public ResponseEntity<ClienteDTO> getByDocumento(@PathVariable String nroDocumento) {
            ...
            public List<Cliente> buscar(@RequestParam String q) {
                return clienteRepository.buscarGeneral(q.toLowerCase());
            }
        }
