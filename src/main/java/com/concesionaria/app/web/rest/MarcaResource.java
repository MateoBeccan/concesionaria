...
/**
 * REST controller for managing {@link com.concesionaria.app.domain.Marca}.
 */
@RestController
...
public class MarcaResource {
    ...
    public ResponseEntity<MarcaDTO> createMarca(@Valid @RequestBody MarcaDTO marcaDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/marcas/" + marcaDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, marcaDTO.getId().toString()))
            .body(marcaDTO);
    }
    ...
    public ResponseEntity<MarcaDTO> updateMarca(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, marcaDTO.getId().toString()))
            .body(marcaDTO);
    }
    ...
    public ResponseEntity<MarcaDTO> partialUpdateMarca(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, marcaDTO.getId().toString())
        );
    }
