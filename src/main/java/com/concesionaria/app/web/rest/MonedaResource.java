...
/**
 * REST controller for managing {@link com.concesionaria.app.domain.Moneda}.
 */
@RestController
...
public class MonedaResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<MonedaDTO>> getAllMonedas(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        LOG.debug("REST request to get a page of Monedas");
        Page<MonedaDTO> page = monedaService.findAll(pageable);
