...
/**
 * REST controller for managing {@link com.concesionaria.app.domain.DetalleVenta}.
 */
@RestController
...
public class DetalleVentaResource {
    ...
    /**
     * {@code GET  /detalle-ventas} : get all the Detalle Ventas.
     *
     * @param pageable the pagination information.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of Detalle Ventas in body.
     */
    @GetMapping("")
    public ResponseEntity<List<DetalleVentaDTO>> getAllDetalleVentas(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
