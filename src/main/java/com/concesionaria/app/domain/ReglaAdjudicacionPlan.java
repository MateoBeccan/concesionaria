...
@Entity
@Table(name = "regla_adjudicacion_plan")
public class ReglaAdjudicacionPlan implements Serializable {
    ...
    @Column(name = "minimo_cuotas")
    private Integer minimoCuotas;

    @Column(name = "minimo_porcentaje", precision = 5, scale = 2)
    private BigDecimal minimoPorcentaje;

    @NotNull
    @Column(name = "permite_mora", nullable = false)
    private Boolean permiteMora = false;

    @NotNull
    @Column(name = "requiere_contrato_activo", nullable = false)
    private Boolean requiereContratoActivo = true;
