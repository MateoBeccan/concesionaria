  ...
  <div class="d-flex justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2 id="concesionariaApp.tipoVehiculo.home.createOrEditLabel" data-cy="TipoVehiculoCreateUpdateHeading">
          Crear o editar Tipo Vehiculo
        </h2>
        <div>
          <div class="mb-3" v-if="tipoVehiculo.id">
            <label for="id">ID</label>
            <input type="text" class="form-control" id="id" name="id" v-model="tipoVehiculo.id" readonly />
          </div>
          <div class="mb-3">
            <label class="form-control-label" for="tipo-vehiculo">Nombre</label>
            <input
              type="text"
              class="form-control"
              name="nombre"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-vehiculo">Descripcion</label>
            <input
              type="text"
              class="form-control"
              name="descripcion"
              id="tipo-vehiculo-descripcion"
              data-cy="descripcion"
...
<script lang="ts" src="./tipo-vehiculo-update.component.ts"></script>
