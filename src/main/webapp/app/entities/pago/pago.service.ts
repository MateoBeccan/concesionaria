...
export default class PagoService {
  ...
  findByVentaId(ventaId: number): Promise<IPago[]> {
    return new Promise<IPago[]>((resolve, reject) => {
      axios
  ...
  create(entity: IPago): Promise<IPago> {
    return new Promise<IPago>((resolve, reject) => {
      axios
  ...
  update(entity: IPago): Promise<IPago> {
    return new Promise<IPago>((resolve, reject) => {
      axios
  ...
  partialUpdate(entity: IPago): Promise<IPago> {
    return new Promise<IPago>((resolve, reject) => {
      axios
