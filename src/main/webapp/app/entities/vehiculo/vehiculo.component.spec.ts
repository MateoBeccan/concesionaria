...
type VehiculoComponentType = InstanceType<typeof Vehiculo>;
...
describe('Component Tests', () => {
  ...
  describe('Vehiculo Management Component', () => {
    ...
    let mountOptions: MountingOptions<VehiculoComponentType>['global'];
    ...
    describe('Mount', () => {
      it('Should call load all on init', async () => {
        ...
        // WHEN
        const wrapper = shallowMount(Vehiculo, { global: mountOptions });
        const comp = wrapper.vm;
        await comp.$nextTick();

        // THEN
        expect(vehiculoServiceStub.retrieve.calledOnce).toBeTruthy();
      ...
      it('should calculate the sort attribute for an id', async () => {
        ...
        // THEN
        expect(vehiculoServiceStub.retrieve.lastCall.firstArg).toMatchObject({
          sort: ['id,asc'],
        });
      });
    });
    describe('Handles', () => {
      let comp: VehiculoComponentType;

      beforeEach(async () => {
        const wrapper = shallowMount(Vehiculo, { global: mountOptions });
        comp = wrapper.vm;
        await comp.$nextTick();
        vehiculoServiceStub.retrieve.reset();
        vehiculoServiceStub.retrieve.resolves({ headers: {}, data: [] });
      });
      ...
      it('should not load a page if the page is the same as the previous page', () => {
        ...
        // THEN
        expect(vehiculoServiceStub.retrieve.called).toBeFalsy();
      });
