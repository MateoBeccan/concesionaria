  ...
  <div class="d-flex justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2 id="concesionariaApp.tipoComprobante.home.createOrEditLabel" data-cy="TipoComprobanteCreateUpdateHeading">
          Crear o editar Tipo Comprobante
        </h2>
        <div>
          <div class="mb-3" v-if="tipoComprobante.id">
            <label for="id">ID</label>
            <input type="text" class="form-control" id="id" name="id" v-model="tipoComprobante.id" readonly />
          </div>
          <div class="mb-3">
            <label class="form-control-label" for="tipo-comprobante">Codigo</label>
            <input
              type="text"
              class="form-control"
              name="codigo"
              id="tipo-comprobante-codigo"
              data-cy="codigo"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-comprobante">Descripcion</label>
            <input
              type="text"
              class="form-control"
              name="descripcion"
              id="tipo-comprobante-descripcion"
              data-cy="descripcion"
...
<script lang="ts" src="./tipo-comprobante-update.component.ts"></script>
