  ...
  <div class="d-flex justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2 id="concesionariaApp.tipoDocumento.home.createOrEditLabel" data-cy="TipoDocumentoCreateUpdateHeading">
          Crear o editar Tipo Documento
        </h2>
        <div>
          <div class="mb-3" v-if="tipoDocumento.id">
            <label for="id">ID</label>
            <input type="text" class="form-control" id="id" name="id" v-model="tipoDocumento.id" readonly />
          </div>
          <div class="mb-3">
            <label class="form-control-label" for="tipo-documento">Codigo</label>
            <input
              type="text"
              class="form-control"
              name="codigo"
              id="tipo-documento-codigo"
              data-cy="codigo"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-documento">Descripcion</label>
            <input
              type="text"
              class="form-control"
              name="descripcion"
...
<script lang="ts" src="./tipo-documento-update.component.ts"></script>
