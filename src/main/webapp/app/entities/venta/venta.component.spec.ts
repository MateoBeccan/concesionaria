...
type VentaComponentType = InstanceType<typeof Venta>;
...
describe('Component Tests', () => {
  ...
  describe('Venta Management Component', () => {
    ...
    let mountOptions: MountingOptions<VentaComponentType>['global'];
    ...
    describe('Mount', () => {
      it('Should call load all on init', async () => {
        ...
        // WHEN
        const wrapper = shallowMount(Venta, { global: mountOptions });
        const comp = wrapper.vm;
        await comp.$nextTick();

        // THEN
        expect(ventaServiceStub.retrieve.calledOnce).toBeTruthy();
      ...
      it('should calculate the sort attribute for an id', async () => {
        ...
        // THEN
        expect(ventaServiceStub.retrieve.lastCall.firstArg).toMatchObject({
          sort: ['id,asc'],
        });
      });
    });
    describe('Handles', () => {
      let comp: VentaComponentType;
      ...
      beforeEach(async () => {
        ...
        ventaServiceStub.retrieve.resolves({ headers: {}, data: [] });
      });
