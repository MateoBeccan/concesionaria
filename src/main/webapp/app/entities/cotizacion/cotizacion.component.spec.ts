...
type CotizacionComponentType = InstanceType<typeof Cotizacion>;
...
describe('Component Tests', () => {
  ...
  describe('Cotizacion Management Component', () => {
    ...
    let mountOptions: MountingOptions<CotizacionComponentType>['global'];
    ...
    describe('Mount', () => {
      it('Should call load all on init', async () => {
        ...
        // WHEN
        const wrapper = shallowMount(Cotizacion, { global: mountOptions });
        const comp = wrapper.vm;
        await comp.$nextTick();

        // THEN
        expect(cotizacionServiceStub.retrieve.calledOnce).toBeTruthy();
      ...
      it('should calculate the sort attribute for an id', async () => {
        ...
        // THEN
        expect(cotizacionServiceStub.retrieve.lastCall.firstArg).toMatchObject({
          sort: ['id,asc'],
        });
      });
    });
    describe('Handles', () => {
      let comp: CotizacionComponentType;

      beforeEach(async () => {
        const wrapper = shallowMount(Cotizacion, { global: mountOptions });
        comp = wrapper.vm;
        await comp.$nextTick();
        cotizacionServiceStub.retrieve.reset();
        cotizacionServiceStub.retrieve.resolves({ headers: {}, data: [] });
      });
      ...
      it('should not load a page if the page is the same as the previous page', () => {
        ...
        // THEN
        expect(cotizacionServiceStub.retrieve.called).toBeFalsy();
      });
