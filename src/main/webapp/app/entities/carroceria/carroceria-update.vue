  ...
  <div class="d-flex justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2 id="concesionariaApp.carroceria.home.createOrEditLabel" data-cy="CarroceriaCreateUpdateHeading">Crear o editar Carroceria</h2>
        <div>
          <div class="mb-3" v-if="carroceria.id">
            <label for="id">ID</label>
            <input type="text" class="form-control" id="id" name="id" v-model="carroceria.id" readonly />
          </div>
          <div class="mb-3">
            <label class="form-control-label" for="carroceria">Nombre</label>
            <input
              type="text"
              class="form-control"
              name="nombre"
              id="carroceria-nombre"
              data-cy="nombre"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="carroceria">Descripcion</label>
            <input
              type="text"
              class="form-control"
              name="descripcion"
              id="carroceria-descripcion"
              data-cy="descripcion"
...
<script lang="ts" src="./carroceria-update.component.ts"></script>
