...
describe('Service Tests', () => {
  describe('Marca Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Marca', async () => {
      ...
      it('should not update a Marca', async () => {
      ...
      it('should partial update a Marca', async () => {
      ...
      it('should not partial update a Marca', async () => {
      ...
      it('should not return a list of Marca', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Marca', async () => {
