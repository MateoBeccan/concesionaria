  ...
  <div class="d-flex justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2 id="concesionariaApp.tipoCaja.home.createOrEditLabel" data-cy="TipoCajaCreateUpdateHeading">Crear o editar Tipo Caja</h2>
        <div>
          <div class="mb-3" v-if="tipoCaja.id">
            <label for="id">ID</label>
            <input type="text" class="form-control" id="id" name="id" v-model="tipoCaja.id" readonly />
          </div>
          <div class="mb-3">
            <label class="form-control-label" for="tipo-caja">Nombre</label>
            <input
              type="text"
              class="form-control"
              name="nombre"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-caja">Descripcion</label>
            <input
              type="text"
              class="form-control"
              name="descripcion"
              id="tipo-caja-descripcion"
              data-cy="descripcion"
...
<script lang="ts" src="./tipo-caja-update.component.ts"></script>
