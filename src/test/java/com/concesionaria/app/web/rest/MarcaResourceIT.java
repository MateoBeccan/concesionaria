...
class MarcaResourceIT {
    ...
    @Test
    @Transactional
    void getAllMarcasByPaisOrigenIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedMarca = marcaRepository.saveAndFlush(marca);

        // Get all the marcaList where paisOrigen equals to
        defaultMarcaFiltering("paisOrigen.equals=" + DEFAULT_PAIS_ORIGEN, "paisOrigen.equals=" + UPDATED_PAIS_ORIGEN);
    }

    @Test
    @Transactional
    void getAllMarcasByPaisOrigenIsInShouldWork() throws Exception {
        // Initialize the database
        insertedMarca = marcaRepository.saveAndFlush(marca);

        // Get all the marcaList where paisOrigen in
        defaultMarcaFiltering("paisOrigen.in=" + DEFAULT_PAIS_ORIGEN + "," + UPDATED_PAIS_ORIGEN, "paisOrigen.in=" + UPDATED_PAIS_ORIGEN);
    }

    @Test
    @Transactional
    void getAllMarcasByPaisOrigenIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedMarca = marcaRepository.saveAndFlush(marca);

        // Get all the marcaList where paisOrigen is not null
        defaultMarcaFiltering("paisOrigen.specified=true", "paisOrigen.specified=false");
    }

    @Test
    @Transactional
    void getAllMarcasByPaisOrigenContainsSomething() throws Exception {
        // Initialize the database
        insertedMarca = marcaRepository.saveAndFlush(marca);

        // Get all the marcaList where paisOrigen contains
        defaultMarcaFiltering("paisOrigen.contains=" + DEFAULT_PAIS_ORIGEN, "paisOrigen.contains=" + UPDATED_PAIS_ORIGEN);
    }

    @Test
    @Transactional
    void getAllMarcasByPaisOrigenNotContainsSomething() throws Exception {
        // Initialize the database
        insertedMarca = marcaRepository.saveAndFlush(marca);

        // Get all the marcaList where paisOrigen does not contain
        defaultMarcaFiltering("paisOrigen.doesNotContain=" + UPDATED_PAIS_ORIGEN, "paisOrigen.doesNotContain=" + DEFAULT_PAIS_ORIGEN);
    }
